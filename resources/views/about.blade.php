    ...
    <div class="container">
        ...
        <div class="row mt-3">
            ...
            <div class="col-10 col-md-8">
                ...
                <ul>
                    <li><strong>Поиск и просмотр туристических мест:</strong> изучайте <a class="text-decoration-none" href="{{ route('TouristPlace')}}">места в Челябинске</a> и добавляйте их в избранное, чтобы не потерять и впоследствии посетить их.</li>
